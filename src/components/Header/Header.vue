      ...
      <div class="menu-nav">
        ...
        <van-cell-group inset>
          <van-cell :clickable=true is-link @click="tipMessage('暂未开发此功能')">
            <template name="title">
              <van-icon name="envelop-o" style="margin-right: 10px"/>我的消息
            </template>
          </van-cell>
          <van-cell :clickable=true is-link @click="tipMessage('暂未开发此功能')">
            <template name="title">
              <van-icon name="points" style="margin-right: 10px"/>云贝中心
            </template>
          </van-cell>
          <van-cell :clickable=true is-link @click="tipMessage('暂未开发此功能')">
            <template name="title">
              <van-icon name="bulb-o" style="margin-right: 10px"/>创作者中心
            </template>
          </van-cell>
        </van-cell-group>
        ...
        <van-cell-group inset title="音乐服务">
          <van-cell :clickable=true is-link @click="tipMessage('暂未开发此功能')">
            <template name="title">
              <van-icon name="shopping-cart-o" style="margin-right: 10px"/>商城
            </template>
          </van-cell>
          <van-cell :clickable=true is-link @click="tipMessage('暂未开发此功能')">
            <template name="title">
              <van-icon name="music-o" style="margin-right: 10px"/>口袋彩铃
            </template>
          </van-cell>
          <van-cell :clickable=true is-link @click="tipMessage('暂未开发此功能')">
            <template name="title">
              <van-icon name="bill-o" style="margin-right: 10px"/>我的订单
            </template>
          </van-cell>
        </van-cell-group>
        <van-cell-group inset>
